...
namespace MGUI.Samples.Controls
{
    public class ProgressBarSamples : SampleBase
    {
        ...
        {
            if (!Desktop.NamedRegions.ContainsKey("BorderlessSteelFloor"))
            {
                Rectangle SteelFloorSourceRect = Desktop.NamedRegions["SteelFloor"].SourceRect.Value;
                Desktop.AddNamedRegion(new NamedTextureRegion("AngryMeteor", "BorderlessSteelFloor", SteelFloorSourceRect.GetCompressed(1), Color.White));
            }
        }
        ...
        public ProgressBarSamples(ContentManager Content, MGDesktop Desktop)
            : base(Content, Desktop, $"{nameof(Controls)}", "ProgressBar.xaml", null, () => { Initialize(Desktop); })
        {
            ...
            Window.AddNamedAction("ResetProgressBar1Progress", x => { ProgressBar1.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar2Progress", x => { ProgressBar2.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar3Progress", x => { ProgressBar3.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar4Progress", x => { ProgressBar4.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar5Progress", x => { ProgressBar5.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar6Progress", x => { ProgressBar6.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar7Progress", x => { ProgressBar7.Value = 0; });
            ...
            Window.AddNamedAction("ResetProgressBar8Progress", x => { ProgressBar8.Value = 0; });
